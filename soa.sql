...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 17 jun 2017 om 02:40
...
CREATE TABLE `klantenbestand` (
  ...
  `gasLeverancier` varchar(255) NOT NULL
...
INSERT INTO `klantenbestand` (`id`, `email`, `gebruikersnaam`, `wachtwoord`, `voornaam`, `achternaam`, `licentie`, `locatie`, `owid`, `energieleverancier`, `enid`, `landcode`, `gasLeverancier`) VALUES
...
(13, 'moons@student.uhasselt.be', 'Rmoons', '$2y$10$uHDqezw6VCkYyq5afzbNFeG5matsRaZpsOa1SDPW5D55IJ2SExFmS', 'Robin', 'Moons', '', 'Houthalen', '2795262', 'Lampiris', '5657382461898752', 'BE', 'ikke'),
(14, '', 'kobe', '$2y$10$Lu/2Dx9WJCisPm2XSl9qaOIBAm2jBFNrXVvXAVNpOPnpeanKrhLUO', 'kbe', 'Bampss', '', '', '', '', '', '', ''),
(15, 'jo.verstraten@hotmail.com', 'jov', '$2y$10$4z28AY/6CQFrhi/NK8AYBOYCs4itsmUZLAOF374q/dP6YTL8uQCv2', '', '', '', '', '', '', '', '', '');
